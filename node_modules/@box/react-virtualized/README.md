...
Once you have made the edits that you want to make, ensure you're in the root of the project and run `yarn publish`. This will deploy this package to our internal, private Artifactory.

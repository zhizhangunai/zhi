  ...
  function getMarkup() {
    var _ref4 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      data: 123
        ...
        flexTableProps = _objectWithoutProperties(_ref4, ["cellDataGetter", "cellRenderer", "columnData", "columnID", "columnStyle", "columnHeaderStyle", "disableSort", "headerRenderer", "maxWidth", "minWidth", "defaultSortDirection", "label", "flexibleCellProps"]);
    ...
    return React.createElement(Table, _extends({
      ...
      rowHeight: 10,
      width: 100
    }, flexTableProps), React.createElement(Column, _extends({
      label: label || 'Name',
      dataKey: "name",
      ...
      id: columnID
    }, flexibleCellProps)), React.createElement(Column, _extends({
      label: "Email",
      dataKey: "email",
      maxWidth: maxWidth,
      minWidth: minWidth,

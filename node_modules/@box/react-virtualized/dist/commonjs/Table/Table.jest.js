...
describe('Table', function () {
  ...
  function getMarkup() {
    var _ref4 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      data: 123
        ...
        label = _ref4.label,
        flexibleCellProps = _ref4.flexibleCellProps,
        flexTableProps = (0, _objectWithoutProperties2["default"])(_ref4, ["cellDataGetter", "cellRenderer", "columnData", "columnID", "columnStyle", "columnHeaderStyle", "disableSort", "headerRenderer", "maxWidth", "minWidth", "defaultSortDirection", "label", "flexibleCellProps"]);
    ...
    return React.createElement(_Table["default"], (0, _extends2["default"])({
      ...
      rowHeight: 10,
      width: 100
    }, flexTableProps), React.createElement(_Column2["default"], (0, _extends2["default"])({
      label: label || 'Name',
      dataKey: "name",
      ...
      id: columnID
    }, flexibleCellProps)), React.createElement(_Column2["default"], (0, _extends2["default"])({
      label: "Email",
      dataKey: "email",
      maxWidth: maxWidth,
      minWidth: minWidth,
      width: 50
    }, flexibleCellProps)), false, true, null, undefined);
  }
  ...
  describe('a11y properties', function () {
    it('should set default aria role on the table', function () {
      var node = (0, _reactDom.findDOMNode)((0, _TestUtils.render)(getMarkup()));
      expect(node.getAttribute('role')).toEqual('grid');
    });
    it('should set aria role on the table based on props value', function () {
      var node = (0, _reactDom.findDOMNode)((0, _TestUtils.render)(getMarkup({
        role: 'table'
      })));
    ...
    it('should set a default aria role on a cell', function () {
      var rendered = (0, _reactDom.findDOMNode)((0, _TestUtils.render)(getMarkup()));
      var cell = rendered.querySelector('.ReactVirtualized__Table__rowColumn');
      expect(cell.getAttribute('role')).toEqual('gridcell');
    });
    it('should set a customized aria role on a cell based on prop values', function () {
      var rendered = (0, _reactDom.findDOMNode)((0, _TestUtils.render)(getMarkup({
        flexibleCellProps: {
          role: 'cell'
        }

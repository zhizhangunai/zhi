...
/**
 * Returns a localization function bound to a set of i18n messages
 * @example import messages from '../i18n/en-US'; const l = getLocalizeFn(messages);
 * @param {Object.<string, string}>} messages
 */
function getLocalizedMessageFormatter(messages) {
     ...
     * @example getByLabelText(l('brui.signInFormTitle'))
     */
    const localizeMessage = (messageId, variables = {}) => {
...
export default getLocalizedMessageFormatter;
